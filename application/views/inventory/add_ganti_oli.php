            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h1 style="color: black; font-size: 2rem;">Tambah Barang Ganti Oli</h1>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo site_url('inventory/add_ganti_oli'); ?>" method="post" onsubmit="return validateForm()">
