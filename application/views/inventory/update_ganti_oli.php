            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo site_url('inventory/ganti_oli'); ?>" class="btn btn-back btn-sm">
                            <i class="fas fa-arrow-left"></i> Back
                        </a>
                        <h1 style="color: black; font-size: 2rem;">Edit Barang Ganti Oli</h1>
                    </div>
                    <div class="card-body">
                        <?php echo form_open('inventory/update_ganti_oli/' . $item['ID_Barang'], 'onsubmit="return validateForm()"'); ?>
                            <div class="form-group">
                                <label for="Nama_Barang">Nama Barang</label>
                                <input type="text" class="form-control" id="Nama_Barang" name="nama_barang" value="<?php echo set_value('nama_barang', $item['Nama_Barang']); ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="Jumlah_Stok" name="jumlah_stok" value="<?php echo set_value('jumlah_stok', $item['Jumlah_Stok']); ?>" required readonly>
